<aside class="hidden md:flex flex-col w-[250px] border-r border-[#53a1b3]/10 bg-[#0f1319] p-2 gap-6 sticky top-0 h-screen overflow-y-auto">
    ...
    <nav class="flex flex-col gap-2">
        ...
        <a href="{{ route('songs.index') }}" class="flex items-center gap-3 px-4 py-2 group transition rounded-[3px] {{ (request()->routeIs('songs.index') || request()->routeIs('songs.show') || request()->routeIs('artists.show')) ? 'bg-[#e96c4c] text-white shadow-lg shadow-[#e96c4c]/20' : 'text-[#53a1b3] hover:bg-[#53a1b3]/10 hover:text-white' }}">
