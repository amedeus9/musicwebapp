...
<div class="flex-1 flex flex-col overflow-y-auto pb-24 gap-1">
    ...
    <div class="mb-4 flex items-center justify-between">
        <h3 class="font-normal text-[#53a1b3] text-xl uppercase tracking-wider">Create Playlist</h3>
    ...
    <div class="bg-[#213042] p-6">
        <form action="{{ route('playlists.store') }}" method="POST" enctype="multipart/form-data" class="max-w-2xl">
            @csrf
